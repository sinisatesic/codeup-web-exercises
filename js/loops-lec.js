...
// While loops
// -will check for a condition, then run the body of the loop.
...
//after running the first time, the condition is checked.
//Once the condition is not true, we exit the loop.
...
// 	i++;
// }
//above will not run, because 10 is not less than 10. Do while loop of above, is below:
...
//here, 10 is not less than 10, so after first run, loop stops
...
// TODO TOGETHER: Console.log each color from the array randomColors
    //note, at bottom, i < randomColors.length is same as i < 5 (array has 5 values]

// var randomColors = ["red","orange","yellow","blue","green","black"]
//
//
